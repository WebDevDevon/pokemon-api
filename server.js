...
const connectionString = 'mongodb+srv://Zunomic:purplefox3333@cluster0.bxmhzrs.mongodb.net/?retryWrites=true&w=majority'
...
//         'picture': 'https://i.ibb.co/84Fj0x3/bug.png',
...
//         'picture': 'https://i.ibb.co/S3hWVQC/electric.png',
...
//         'picture': 'https://i.ibb.co/Jvpb64K/fairy.png',
...
//         'picture': 'https://i.ibb.co/bNt7TJP/fighting.png',
...
//         'picture': 'https://i.ibb.co/yQ8hSHm/flying.png',
...
//         'picture': 'https://i.ibb.co/1n1zt7B/ghost.png',
//         'strong': 'Strong against Ghost, Psychic',
...
//         'picture': 'https://i.ibb.co/RNZPQ2j/grass.png',
...
//         'picture': 'https://i.ibb.co/wpN3jmx/ground.png',
...
//         'picture': 'https://i.ibb.co/2nbYqRk/ice.png',
...
//         'picture': 'https://i.ibb.co/hBrNKXq/normal.png',
...
//         'picture': 'https://i.ibb.co/wLm803w/poison.png',
...
//         'picture': 'https://i.ibb.co/qCMCZtk/psychic.png',
...
//         'picture': 'https://i.ibb.co/fGj8hsK/rock.png',
...
//         'picture': 'https://i.ibb.co/ncyrnFV/Steel.png',
...
//         'picture': 'https://i.ibb.co/mhCztcc/water.png',
...
MongoClient.connect(connectionString)
    .then(client => {
        ...
        const db = client.db('pokemon-types')
        const infoCollection = db.collection('pokemon')
  
        app.get('/api/:pokemonType', (req, res) => {
            const Types = req.params.pokemonType.toLowerCase()
            infoCollection.find({type: Types}).toArray()
            .then(results => {
                console.log(results)
                res.json(results[0])
            })
